        ...
        throws BusinessProcessException
    {
        try
        {
            ...
            if(crudcomponentsession instanceof MultipleCRUDComponentSession)
                return ((MultipleCRUDComponentSession)crudcomponentsession).inizializzaBulkPerModifica(actioncontext.getUserContext(), aoggettobulk);
            for(int i = 0; i < aoggettobulk.length; i++)
        ...
        throws BusinessProcessException, ValidationException
    {
        try
        {
            ...
            if(crudcomponentsession instanceof MultipleCRUDComponentSession)
            {
                ...
                ((MultipleCRUDComponentSession)crudcomponentsession).modificaConBulk(actioncontext.getUserContext(), aoggettobulk);
            } else
            {
