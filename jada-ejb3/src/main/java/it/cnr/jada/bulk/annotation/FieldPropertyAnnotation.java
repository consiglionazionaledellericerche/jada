...
public @interface FieldPropertyAnnotation{
	...
	/** Nome logico del FieldProperty, l'attributo � obbligatorio, ed � univoco all'interno del documento.*/
	public String name();
	...
	/**
	 * Nome della propiet� del JavaBean da visualizzare, viene usato per i FieldProperty di tipo "DESCTOOL".
	 */
	...
	/**
	 * Se valorizzato � il nome di una property del JavaBean da utilizzare per convertire il valore
	 ...
	 * Se inputType � uguale a SELECT il dizionario viene anche usato per ottenere l'elenco dei valori con cui riempire l'elenco delle opzioni.
	 */
	public String keysProperty() default "";
	/**
	 * Se valorizzato � il nome di una property del JavaBean da utilizzare per riempire l'elenco delle
	 * opzioni di nel caso in cui inputType � "SELECT".
	...
	/**
	 * Se valorizzato � il nome di una property da utilizzare per ottenere la disabilitazione dinamica del campo di input.
	 * La property deve essere di tipo Boolean e se il suo valore � true il campo viene disabilitato.
	 */
	public String readonlyProperty() default "";
	/**
	 * Nome della property da usare se il FormController si trova in modalit� FormController.EDIT 
	 * per disabilitare in modo dinamico il campo di input.
	 * La property deve essere di tipo Boolean e se il suo valore � true il campo viene disabilitato.
	 */
	public String readonlyPropertyOnEdit() default "";
	/**
	 * Nome della property da usare se il FormController si trova in modalit� FormController.INSERT 
	 * per disabilitare in modo dinamico il campo di input.
	 * La property deve essere di tipo Boolean e se il suo valore � true il campo viene disabilitato.
	 */
	public String readonlyPropertyOnInsert() default "";
	/**
	 * Nome della property da usare se il FormController si trova in modalit� FormController.SEARCH 
	 * per disabilitare in modo dinamico il campo di input.
	 * La property deve essere di tipo Boolean e se il suo valore � true il campo viene disabilitato.
	 */
	public String readonlyPropertyOnSearch() default "";
	/**
	 * Nome della property da usare se il FormController si trova in modalit� FormController.FREESEARCH 
	 * per disabilitare in modo dinamico il campo di input.
	 * La property deve essere di tipo Boolean e se il suo valore � true il campo viene disabilitato.
	 */
	public String readonlyPropertyOnFreeSearch() default "";
	/**
	 * Nome della property da usare se il FormController si trova in modalit� FormController.VIEW 
	 * per disabilitare in modo dinamico il campo di input.
	 * La property deve essere di tipo Boolean e se il suo valore � true il campo viene disabilitato.
	 */
	 ...
	 * "DESCTOOL" --> Corrisponde ad campo di input html a cui � associato una "descProperty" da valorizzare per mostrare una property ulteriore a quella di base.
	 */
	public InputType inputType() default InputType.UNDEFINED;
	/**
	 * Tipo di layout da applicare; pu� assumere i valori
	 * "HORIZONTAL" e "VERTICAL"; attualmente � valido solo
	 ...
	 * Pu� essere il nome di una classe Format. 
	 */
	public FormatName formatName() default FormatName.NoFormat;
	/**
	 * Se true il campo viene abilitato in modalit� FormController.SEARCH
	 */
	public boolean enabledOnSearch() default false;
	/**
	 * Se true il campo viene abilitato in modalit� FormController.INSERT
	 */
	public boolean enabledOnInsert() default true;
	/**
	 * Se true il campo viene abilitato in modalit� FormController.EDIT
	 */
	public boolean enabledOnEdit() default true;
	/**
	 * Se true il campo viene abilitato in modalit� FormController.FREESEARCH
	 */
	public boolean enabledOnFreeSearch() default true;
	/**
	 * Se true il campo viene abilitato in modalit� FormController.VIEW
	 */
	public boolean enabledOnView() default false;
	/**
	 * Se vale false le ricerche vengono effettuate "case insensitive" 
	 * (sia quelle con = che con LIKE), il default � true.
	 */
	public boolean caseSensitiveSearch() default true;
	/**
	 * Se true il FormController che governa l'editing del JavaBean pu� tentare di completare automaticamente
	 ...
	 * Se l'utente seleziona tale voce la property viene impostata a null.Il deafult � true,
	 ...
	 * all'atto della validazione si pu� anche specificare il metodo doDefault comune a tutte le Action. 
	 */
