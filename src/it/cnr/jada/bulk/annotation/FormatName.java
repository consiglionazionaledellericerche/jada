...
public enum FormatName {	
	...
	static{
		...
		formatNameForAnnotation.put("UppercaseStringFormat","it.ibm.bframe.util.UppercaseStringFormat");
		formatNameForAnnotation.put("LowercaseStringFormat","it.ibm.bframe.util.LowercaseStringFormat");
		formatNameForAnnotation.put("PrimitiveNumberFormat","it.ibm.bframe.bulk.PrimitiveNumberFormat");
