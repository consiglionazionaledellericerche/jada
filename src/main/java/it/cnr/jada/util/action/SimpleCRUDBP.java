...
public class SimpleCRUDBP extends CRUDBP
	implements Serializable
{
		...
		throws BusinessProcessException
	{
		try
		{
			OggettoBulk oggettobulk = (OggettoBulk)searchBulkClass.newInstance();
			oggettobulk.setUser(actioncontext.getUserInfo().getUserid());
			return oggettobulk;
		}
		catch(Exception exception)
	...
	private void setBulkClass(Class class1)
	...
	public void setSearchBulkClassName(String s)
		throws ClassNotFoundException
	{
		if(s != null)
	...
	/**
	 * Metodo da sovrascrivere nelle classi Bulk figlie
	 * che implementeranno la gestione PostIt
	 * 1. Progetti
	 */
